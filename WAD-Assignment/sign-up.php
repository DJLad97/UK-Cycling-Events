<?php
  ...
  if($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $add1 = filter_var(strip_tags(trim($_POST['add1'])), FILTER_SANITIZE_STRING);
      $add2 = filter_var(strip_tags(trim($_POST['add2'])), FILTER_SANITIZE_STRING);
      $townCity = filter_var(strip_tags(trim($_POST['townCity'])), FILTER_SANITIZE_STRING);
      $county = filter_var(strip_tags(trim($_POST['county'])), FILTER_SANITIZE_STRING);
      $postCode = filter_var(strip_tags(trim($_POST['postCode'])), FILTER_SANITIZE_STRING);
      $country = filter_var(strip_tags(trim($_POST['country'])), FILTER_SANITIZE_STRING);
      ...
      if(empty($add1)){
        $error[] = "Please provide the first line of your address!";
      }
      if(empty($townCity)){
          $error[] = "Please provide your town/city!";
      }
      if(empty($county)){
          $error[] = "Please provide your county!";
      }
      if(empty($postCode)){
